...
export interface ResultJob {
    ...
    * @memberof ResultJob
    */
   'type': ResultJobTypeEnum;
   /**
    *
    * @type {string}
    * @memberof ResultJob
    */
   'status': ResultJobStatusEnum;
   /**
    *
    * @type {object}
    * @memberof ResultJob
...
export const ResultJobTypeEnum = {
   CalcBinSizes: 'calc_bin_sizes',
   CalcPredictions: 'calc_predictions',
   CalcDailyHistograms: 'calc_daily_histograms',
   CreateVoucher: 'create_voucher',
   AddIndex: 'add_index',
   CreateSample: 'create_sample'
} as const;

export type ResultJobTypeEnum = typeof ResultJobTypeEnum[keyof typeof ResultJobTypeEnum];
export const ResultJobStatusEnum = {
   Running: 'running',
   Done: 'done',
   Failed: 'failed',
   Pending: 'pending'
...
export type ResultJobStatusEnum = typeof ResultJobStatusEnum[keyof typeof ResultJobStatusEnum];
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
   return {
       ...
       * @throws {RequiredError}
       */
      getJobById: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         // verify required parameter 'id' is not null or undefined
...
export const DefaultApiFp = function (configuration?: Configuration) {
   ...
   return {
       ...
       * @throws {RequiredError}
       */
      async getJobById(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResultJob>> {
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
   ...
   return {
       ...
       * @throws {RequiredError}
       */
      getJobById(id: number, options?: any): AxiosPromise<ResultJob> {
...
export class DefaultApi extends BaseAPI {
    ...
    * @memberof DefaultApi
    */
   public getJobById(id: number, options?: AxiosRequestConfig) {
      return DefaultApiFp(this.configuration).getJobById(id, options).then((request) => request(this.axios, this.basePath));
   }
...
export const EvaluationApiAxiosParamCreator = function (configuration?: Configuration) {
   return {
      ...
      /**
       *
       * @summary Get Collection Vouchers
       * @param {VoucherRequest} voucherRequest
       * @param {*} [options] Override http request option.
       * @throws {RequiredError}
       */
      getSpeciesVouchers: async (voucherRequest: VoucherRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         // verify required parameter 'voucherRequest' is not null or undefined
         assertParamExists('getSpeciesVouchers', 'voucherRequest', voucherRequest)
         const localVarPath = `/evaluation/collection-vouchers`;
         // use dummy base URL string because the URL constructor only accepts absolute URLs.
         const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         let baseOptions;
         if (configuration) {
...
export const EvaluationApiFp = function (configuration?: Configuration) {
   ...
   return {
       ...
       * @throws {RequiredError}
       */
      async getSpeciesVouchers(voucherRequest: VoucherRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobCreatedResponse>> {
         const localVarAxiosArgs = await localVarAxiosParamCreator.getSpeciesVouchers(voucherRequest, options);
         return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
      },
   }
};
...
export const EvaluationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
   ...
   return {
       ...
       * @throws {RequiredError}
       */
      getSpeciesVouchers(voucherRequest: VoucherRequest, options?: any): AxiosPromise<JobCreatedResponse> {
         return localVarFp.getSpeciesVouchers(voucherRequest, options).then((request) => request(axios, basePath));
      },
   };
};
...
export class EvaluationApi extends BaseAPI {
    ...
    * @memberof EvaluationApi
    */
   public getSpeciesVouchers(voucherRequest: VoucherRequest, options?: AxiosRequestConfig) {
      return EvaluationApiFp(this.configuration).getSpeciesVouchers(voucherRequest, options).then((request) => request(this.axios, this.basePath));
   }
}
